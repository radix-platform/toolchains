...
diff -b --unified -Nr  binutils-$VERSION-orig  binutils-$VERSION > binutils-$VERSION-dynamic-section-warn.patch

mv binutils-$VERSION-dynamic-section-warn.patch ../patches
